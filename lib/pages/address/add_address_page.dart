...
class _AddAddressPageState extends State<AddAddressPage> {
  ...
  CameraPosition _cameraPosition =
      const CameraPosition(target: LatLng(51.501476, -0.140634), zoom: 17);

  LatLng _initialPosition = const LatLng(51.501476, -0.140634);
              ...
              return SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: Dimensions.width20),
                      child: const BigText(text: "Contact phone"),
                    ),
                    SizedBox(
                      height: Dimensions.height10,
                    ),
                        ...
                        locationController.addAddress(_addressModel).then(
                          (response) {
                            if (response.isSuccess) {
                              ...
                              Get.snackbar("Address", "Addess Successfully");
                            } else {
